...
class WixAuthController {
    ...
    redirectUrlHandler = async (req, res) => {
        ...
        const {refresh_token, accessToken} = await this.wixOAuthFacade.getTokensFrom(req.query.code);
        await this.refreshTokenDao.save(req.query.instanceId, refresh_token);
