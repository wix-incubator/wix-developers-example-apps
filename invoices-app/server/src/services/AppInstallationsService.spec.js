...
describe('AppInstallationsService', () => {
    ...
    it('should create a new object for some instanceId', async () => {
        ...
        await expect(service.getBy(instanceId)).resolves.toEqual({createDate: date, isInstalled: true});
    });
    ...
    it('should allow updating installed flag', async () => {
        ...
        await expect(service.getBy(instanceId)).resolves.toEqual({createDate: date, isInstalled: false});
    });
})
